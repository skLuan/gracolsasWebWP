...
function init_template()
{
    ...
    if (!is_admin()) {
        wp_enqueue_style('swipercss', 'https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.css', [], '1.0', 'all');
        wp_enqueue_style('tailwind', get_stylesheet_directory_uri() . '/assets/css/output.css', ['fonts', 'swipercss'], '1.0', 'all');
    ...
    wp_enqueue_script('iconify', 'https://code.iconify.design/iconify-icon/1.0.0-beta.2/iconify-icon.min.js', '', '1.0', true);
    wp_enqueue_script('lazysizes', get_stylesheet_directory_uri() . '/assets/js/lazysizes.min.js', '', '1.0', true);
    wp_enqueue_script('swiper', 'https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js', ['lazysizes'], '1.0', true);
    wp_enqueue_script('gracolSwiper', get_stylesheet_directory_uri() . '/assets/js/swipers.js', ['swiper'], '1.8.1', true);
    wp_enqueue_script('main', get_stylesheet_directory_uri() . '/assets/js/main.js', ['iconify', 'lodash', 'swiper', 'gracolSwiper', 'lazysizes'], '1.8.1', true);
    wp_enqueue_script('infoBlock', get_stylesheet_directory_uri() . '/assets/js/infoBlock.js', ['wp-blocks', 'wp-element', 'wp-components'], '1.8.1', true);
    wp_enqueue_script('acordeon', get_stylesheet_directory_uri() . '/assets/js/acordeon.js', ['iconify', 'lodash', 'swiper', 'gracolSwiper'], '1.8.1', true);
    if(is_singular('proyectos')){
        wp_enqueue_script('formSend', get_stylesheet_directory_uri() . '/assets/js/proyectoSend.js', ['main'], '1.8.1', true);
    ...
    if(is_page('cliente')){
        wp_enqueue_script('btnsCliente', get_stylesheet_directory_uri() . '/assets/js/btns-cliente.js', [], '1.8.1', true);
    }
