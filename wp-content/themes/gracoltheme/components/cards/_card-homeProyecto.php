...
?>
<div class="w-full flex flex-col bg-white rounded-sm shadow-lg">
    ...
    <a class="flex mt-auto items-center justify-center w-full pt-2 pb-3 text-lg underline bg-greenG text-whiteG font-futuraBold" href="<?= $cardData->getPLink() ?>">Ver proyecto</a>
</div>