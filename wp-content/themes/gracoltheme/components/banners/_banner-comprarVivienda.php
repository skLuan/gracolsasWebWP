<section class="w-full md:w-4/5 lg:w-full max-w-screen-2xl md:mx-auto gap-y-8 lg:mt-10">
    <div class="flex flex-col w-full p-3 text-center bg-center bg-cover" style="background-image: url('<?= IMAGE . 'card-compracasitas.png' ?>'); height: 312px">
