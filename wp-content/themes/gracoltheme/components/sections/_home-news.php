...
<section class="relative mb-10 overflow-auto md:max-w-screen-2xl md:mx-auto">
    ...
    <div class="w-full mb-5 text-center bg-center bg-no-repeat bg-cover overflow-hidden flex items-center justify-center">
        <picture>
            <img class="h-36 max-w-none" src="<?= IMAGE . 'ultimas-noticias.png' ?>" alt="news banner">
        </picture>
    </div>
