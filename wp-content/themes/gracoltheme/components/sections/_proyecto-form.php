...
<section id="gs_FormProject" class="py-32 mx-auto shadow-lg max-w-screen-2xl bg-greenG">
    <form method="POST" class="relative p-5 pb-0 mx-5 rounded-lg shadow-lg bg-whiteG lg:w-1/2 lg:mx-auto" action="url_de_tu_api">
        ...
        <input type="submit" class="relative flex px-10 py-2 mx-auto my-2 text-white rounded w-fit -bottom-4 bg-orangeG font-futuraBold" value="Enviar">
