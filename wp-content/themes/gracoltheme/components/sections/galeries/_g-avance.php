...
?>
<div id="img_avance" class="relative hidden w-full px-5 mx-auto mb-10 gs_slide animate__animated animate__faster animate__fadeInDown max-w-screen-2xl">
    <!-- thmbslider -->
    ...
    <div class="relative overflow-hidden swiper swiper-single-project-avance">
