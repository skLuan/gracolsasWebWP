...
<section class="relative w-full mx-auto max-w-screen-2xl">
    ...
    <div class="grid grid-cols-1 p-10 pt-0 lg:grid-cols-3 sectionAsesores">
        <h3 class="relative max-w-2xl px-5 py-2 mx-auto text-4xl text-center -translate-y-7 col-span-full text-whiteG bg-orangeG drop-shadow-md">Estamos listos para atenderte</h3>
